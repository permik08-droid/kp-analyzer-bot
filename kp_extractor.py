...
- Поставщика ищи по названию организации в шапке, подвале, реквизитах, подписи, печати, блоке контактов.
- Если внизу КП или в реквизитах есть ООО, ИП, АО, ТОО — это обычно поставщик.
- Не путай поставщика с покупателем, грузополучателем, производителем или транспортной компанией.
...
- ИНН ищи в реквизитах поставщика по словам: ИНН, ИНН/КПП.
- ОГРН ищи в реквизитах поставщика по словам: ОГРН, ОГРНИП.
